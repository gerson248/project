    ...
    MongoBinaryDownloadUrl.prototype.getArchiveNameWin = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                name += "-" + this.arch;
                if (!util_1.isNullOrUndefined(semver.coerce(this.version))) {
    ...
    MongoBinaryDownloadUrl.prototype.getArchiveNameOsx = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!util_1.isNullOrUndefined(version) && semver.gte(version, '3.2.0')) {
                    name += '-ssl';
                }
                if (util_1.isNullOrUndefined(version) || semver.gte(version, '4.2.0')) {
    ...
    MongoBinaryDownloadUrl.prototype.translatePlatform = function (platform) {
        switch (platform) {
            ...
            case 'win32':
                ...
                if (util_1.isNullOrUndefined(version))
                    return 'windows';
